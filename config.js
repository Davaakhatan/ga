...
export const courseRegexMapping = {
  ...
  cybersecurity: {
    ...
    sophomore: {
      ...
      spring: generateRegex(["CIS_219", "CYSEC_212", "CIS_375"]),
    },
    junior: {
      fall: generateRegex(["CYSEC_301", "CYSEC_306", "CRJS_241", "MATH_213"]),
      spring: generateRegex(["MATH_310", "ENG_380", "CYSEC_302", "CYSEC_307"]),
    },
    senior: {
  ...
  "software-engineering-dual-degree": {
    ...
    sophomore: {
      fall: generateRegex(["CSC_220", "CIS_239", "MATH_222", "CIS_277", "CIS_287"]),
      spring: generateRegex(["CIS_255", "CSC_223", "MATH_223", "MATH_314", "SOFT_210", "MATH_213", "MATH_312", "CIS_377"]),
    },
    junior: {
